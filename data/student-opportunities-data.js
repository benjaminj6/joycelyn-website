...
data.weekly_lessons = {
	...
	par_1: `Private instruction in music is highly individualized and can be tailored to fit the 
...
data.group_classes = {
	...
	par_1: `Students in my studio are required to participate in supplementary group classes that meet 
	...
	benefits of group class include allowing students to thrive socially and musically.`.replace(`/\\n/g`, ``),
};
...
data.recitals = {
	...
	par_1: `Every semester, my students perform in a recital.  Recitals are an exciting time for 
	...
	their hard work come to fruition.`.replace(`/\\n/g`, ``),
};
...
data.parents = {
	...
	par_1: `Parent education is something that I am passionate about.  Because I believe that parents 
		...
		etiquette, and much more.`.replace(`/\\n/g`, ``),

	par_2: `Additionally, I occasionally hold private parent-teacher conferences to check in on how 
	the students are doing during home practice.  These meetings allow me to brainstorm with parents 
	on how to meet their child’s individual practice needs.`.replace(`/\\n/g`, ``),

	par_3: `On top of these resources, I have partnered with a fellow violin teacher, Amanda 
