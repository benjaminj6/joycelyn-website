...
let body = `
	<main>
		...
		<section class="video video-1">
			...
			<iframe type="text/html" src="${data.video_1.src}" frameborder="0" allowfullscreen></iframe>
		</section>
		<section class="video video-2">
			<h3>${data.video_2.h3}</h3>
			<iframe type="text/html" src="${data.video_2.src}" frameborder="0" allowfullscreen></iframe>
		</section>
		<section class="video video-3">
			<h3>${data.video_3.h3}</h3>
			<iframe type="text/html" src="${data.video_3.src}" frameborder="0" allowfullscreen></iframe>
		</section>
	</main>
`;
