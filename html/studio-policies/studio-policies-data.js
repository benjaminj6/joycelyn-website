...
data.travel = {
	h2: `Travel`,
	par_1: _.removeBreaks(`Only in very rare circumstances do I drive to my student’s homes.  I ask that all students 
		come take lessons in either my La Mirada or Walnut location.  If I do drive to my student’s 
		home, there will be an additional gas fee for every lesson.`),
};
...
data.parents = {
	...
	practice_partners: {
		...
		par_1: _.removeBreaks(`I believe that parent’s participation in their student’s musical education is the 
			...
			each day with the student at home.`),

		par_2: _.removeBreaks(`Unless a student has been approved to practice on their own, a parent or practice 
			partner should be present during lessons and practices at all times.`),

		par_3: _.removeBreaks(`Parents, I understand that many of you are busy and that you may not have time 
			...
			may not be the correct fit for you.`),
	},

	being_late: {
		h3: `Being late:`,
		par_1: _.removeBreaks(`Unfortunately, my schedule is not very flexible. If you are late to a lesson, 
			I will not be able to make up the lost time by pushing the lesson later.  There will 
			be no refunds or make ups for late lessons.`),
	},

	teacher_error: {
		h3: `Teacher error:`,
		par_1: _.removeBreaks(`If I am more than 15 minutes late to a lesson, I will either refund your money 
			...
			a steady schedule, but unfortunately plans change very quickly sometimes.`),
	},

	makeups: {
		h3: `Makeups:`,

		par_1: _.removeBreaks(`I understand that sometimes schedules may change and you might need to
		...
		par_2: _.removeBreaks(`The only exception to this rule is if there is a family emergency or unpredictable 
			circumstance (such as car trouble). Please note that forgetting about lessons or traffic are 
			not valid examples of “unpredictable circumstances”.`),

		par_3: _.removeBreaks(`Regarding illness, I allow my students to take three sick days a year.  3 lesson out of 
			...
			days that year, that lesson will be cancelled and the cost forfeited.`),
	},

	new_students: {
		h3: `New Students:`,

		par_1: _.removeBreaks(`I offer a ${ _.aTag('../contact/', 'free trial lesson') } to all new students (whether 
			...
			after 6 months, the student has given violin a “fair shot”.`),
	},

	payment: {
		h3: `Payment:`,
		par_1: _.removeBreaks(`At the first lesson of every month, please pay for all the lessons of that month 
			...
			is due so that each family will be informed of their fees for that month.`),

		par_2: _.removeBreaks(`Typically, I do not discuss my tuition rates over email or display them on my website.  
			I prefer to discuss that in person during a ${ _.aTag('../contact/', 'free trial lesson') }.`),
	},
};

data.parents.instruments = {
	h3: `Instruments:`,
	par_1: _.removeBreaks(`Picking the right instrument is absolutely crucial to your child’s success with the violin.  
		...
		renting a violin from ${ _.aTag('http://www.moreysmusic.com/', `Morey's Music Shop`) } in Lakewood. Morey’s provides high 
		...
		I want is for one of my students to end up with a badly made violin that harms their technique.`),
};
...
data.students = {
	...
	fingernails: {
		h3: `Fingernails:`,
		par_1: _.removeBreaks(`As you’ll discover, it’s very difficult to play the violin with long fingernails. If 
			...
			in the tip jar.  Sometimes students win up to $5-$10!`),
	},
	listening: {
		h3: `Listening:`,
		par_1: _.removeBreaks(`One of the most important components of the Suzuki Method is listening. If your student 
			is playing past Twinkle, listen to your CD at least once a day, <em>every day.</em> This will 
			allow you to learn pieces with more ease.`),
	},
	practicing: {
		h3: `Practicing:`,
		par_1: _.removeBreaks(`I would like all students in my studio to practice at least 6 days a week with their 
			...
			unprepared to lessons, then I will excuse them from my studio.`),
	},
};
